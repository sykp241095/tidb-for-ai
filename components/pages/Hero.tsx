...
import { INSTALL_COMMANDS } from '@/lib/constants/commands'
  ...
  <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-black dark:to-gray-950">
    <div className="max-w-7xl mx-auto">
      <div className="text-center max-w-4xl mx-auto">
        ...
        <div className="h-16 bg-gray-200 dark:bg-gray-700 rounded animate-pulse mb-6" />
        <div className="h-8 bg-gray-200 dark:bg-gray-700 rounded animate-pulse mb-12" />
      </div>
    </div>
  </section>
)
...
const CopyCommand: React.FC<CopyCommandProps> = ({ command, copied, onCopy }) => (
...
const StatsGrid: React.FC<StatsGridProps> = ({ stats, className, style }) => (
  <div className={cn("grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto", className)} style={style}>
...
const Hero: React.FC<HeroProps> = ({ className }) => {
  ...
  const handleCopy = useCallback(() => {
    copyToClipboard(INSTALL_COMMANDS.pip)
  }, [copyToClipboard])
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <StatsGrid
            ...
            style={{ animationDelay: ANIMATION_DELAYS.stats } as React.CSSProperties}
          />
        </div>
      </div>
    </section>
